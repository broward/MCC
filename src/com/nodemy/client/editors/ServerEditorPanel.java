...
/**
 * Detail editor for mBean of type "Server".
 * 
 *
 */
public class ServerEditorPanel extends AbstractEditorPanel implements ActionListener {
	private static final long serialVersionUID = -614091574795985431L;

	public ServerEditorPanel(ObjectInstance objectInstance) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			...
			result = JMXConnectionSingleton.getInstance().getmBeanServer().invoke(objectInstance.getObjectName(), button.getName(), null, null);
